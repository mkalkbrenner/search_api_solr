 ...
 *     "field_type_language_code" = "fieldTypeLanguageCode",
 *     "domains",
 *     "field_type" = "fieldType",
 *     "unstemmed_field_type" = "unstemmedFieldType",
 *     "spellcheck_field_type" = "spellcheckFieldType",
 *     "collated_field_type" = "collatedFieldType",

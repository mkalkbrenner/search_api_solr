...
class SearchApiSolrLocationTest extends BackendTestBase {
  ...
  public function testBackend() {
    ...
    $query = $this->buildSearch(NULL, [], NULL, FALSE)
      ->addCondition('location', array('100', '6000'), 'BETWEEN')
    ...
    $facets = array();
    $facets['location__distance'] = array(
    ...
    $facets = $result->getExtraData('search_api_facets', array())['location__distance'];
    ...
    $query = $this->buildSearch(NULL, [], NULL, FALSE)
      ->addCondition('location', array('100', '1000'), 'BETWEEN')
      ->sort('location__distance');
  ...
  protected function checkServerBackend() {
    // TODO: Implement checkServerBackend() method.
  }
  ...
  protected function checkSecondServer() {
    // TODO: Implement checkSecondServer() method.
  }
  ...
  protected function checkModuleUninstall() {
    // TODO: Implement checkModuleUninstall() method.
  }
